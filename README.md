...
Once you've pulled down the package (either by adjusting your composer.json with a VCS path or adding it to packagist), it will be stored in your `vendor` folder for local access. 
